...
export default function head(){
    return (
        ...
        <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
            <Link href="/" className="mr-4 block py-1.5 text-base font-semibold text-slate-800">
                권지민
            </Link>
            {/* <a
                href="/권지민_이력서.pdf"
                download
                className="inline-block mt-6 rounded-md border px-4 py-2 text-sm hover:bg-neutral-100"
            >
                Resume Download →
            </a> */}
