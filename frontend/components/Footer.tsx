    ...
    return(
        ...
        <div className="w-full px-8 mx-auto max-w-7xl">
            ...
            <div className="grid justify-between grid-cols-3 gap-4">
                ...
                <li>
                    <a href="project/dagudok" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                    다구독다구독
                    </a>
                </li>
                <li>
                    <a href="project/aesop" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                    이솝의 메아리
                    </a>
                </li>
                <li>
                    <a href="project/mappride" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                    Mappride
                    </a>
                </li>
                <li>
                    <a href="project/dontsleep" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                    졸음운전 방지 시스템
                    </a>
                </li>
                </ul>
